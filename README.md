...
tools/ro-repo accept-package --manifest incoming/component-artifact-manifest-v1.json --artifacts incoming --accepted .work/accepted --report .work/acceptance-report-v1.json
