...
manifest={'schema_version':1,'component':'ro-control','source_repository':'Project-Ro-ASD/ro-Control','source_commit':'a'*40,'release_tag':'v9.9.9','release_id':1,'workflow_run':1,'fedora_release':44,'artifacts':items,'provenance':{'provider':'local-test','subject_digest':'b'*64},'attestation':{'provider':'local-test','verification':'local-test'},'sbom':None}
